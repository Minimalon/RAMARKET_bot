...
import datetime
from core.insales.parsing import parse
from core.insales.composing import compose
from core.insales.connection import Connection
...
class InSalesApi(object):
    ...
    def get_payment_gateways(self):
        return self._get('/admin/payment_gateways.xml')

    async def get_stock_currencies(self):
        return self._get('/admin/stock_currencies.xml')

    def get_application_charges(self):
        return self._get('/admin/application_charges.xml')

    def get_account(self):
        return self._get('/admin/account.xml')
    ...
    async def get_products_by_collection(self, collection_id):
        return self._get('/admin/collects.xml?collection_id=%s' % collection_id)
