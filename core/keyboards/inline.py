...
def kb_taxes():
    ...
    keyboard.button(text='9 %', callback_data=Taxes(tax=0.09))
    keyboard.button(text='10 %', callback_data=Taxes(tax=0.10))
    keyboard.button(text='11 %', callback_data=Taxes(tax=0.11))
    keyboard.button(text='15 %', callback_data=Taxes(tax=0.15))
    keyboard.button(text='16 %', callback_data=Taxes(tax=0.16))
